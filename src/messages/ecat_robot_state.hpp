...
/*!
 * @file ecat_robot_state.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen.
 */

#ifndef FAST_DDS_GENERATED__ECAT_ROBOT_STATE_HPP
#define FAST_DDS_GENERATED__ECAT_ROBOT_STATE_HPP
...
private:
    ...
    std::array<double, 12> m_joints_temperature{0.0};
    std::array<double, 12> m_joints_position{0.0};
    std::array<double, 12> m_joints_velocity{0.0};
    std::array<double, 12> m_joints_acceleration{0.0};
    std::array<double, 12> m_joints_torques{0.0};
    std::array<double, 12> m_preassure1{0.0};
    std::array<double, 12> m_preassure2{0.0};
    std::array<double, 12> m_joints_torques_from_current{0.0};
    std::array<double, 12> m_motors_current{0.0};
    std::array<double, 4> m_feet_contact{0.0};
    std::array<double, 12> m_feet_position{0.0};
    ...
    std::array<double, 12> m_chirp_freq{0.0};

};

#endif // _FAST_DDS_GENERATED_ECAT_ROBOT_STATE_HPP_
